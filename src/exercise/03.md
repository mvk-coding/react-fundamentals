...
> Before when Babel was mentioned it sounded like some code to 
> perform some magic ritual to translate jsx. The combination of 
> seeing what Babel does in this exercise and the way createElement()
> works as shown in the previous exercise, does create clarity on 
> what Babel does. It is less magic and more logic now. Next to that,
> the second extra credit exercise helps to understand the spread
> operator when used for props, or with JSX in general. 
