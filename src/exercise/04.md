...
> As I am learning more about the fundamentals of Reacts, I also learn
> more about some naming conventions used in React and JSX. Although I
> was familiar with the use of capitalized names for custom components, 
> it is interesting to see why this is necessary for the code to be 
> compiled correctly. Furthermore the exercise gave good insight in the 
> different options to write a function and using it to render a custom 
