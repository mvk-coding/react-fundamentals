...
> Next to learning about forms and handleSubmit, it is nice to know that 
> there is a fucntion to prevent default behavior of input elements. Though
> I am not sure this will be used a lot directly, I can image the use of it 
> is a part of form handling packages. Furthermore, this lesson introduced the
> use of console.dir() to me, which is certainly a function to remember. Next to
> console.log and console.error it can be useful for understanding and debugging 
> code. Small not to self: htmlFor is the jsx equivalent of the for attribute.
> Although I heard of Ref before, I never used it. The extra credit made
> this first introdiction look relatively simple. I'm looking forward to 
> learn more about what Refs can do.
> Furthermore, good to know that one can make an input controllable 
> with useState, value and setValue.
