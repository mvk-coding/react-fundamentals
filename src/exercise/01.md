...
> At first this first lesson felt as a repetition of what I already
> knew. I've seen the script tag before and in other courses also used
> it in exercises. As I have little field experience in building 
> web pages directly in HTML outside of the coding courses I did, I 
> have also little experiecne with the script tag. I cannot remember 
> typing it as a "module" before, so it was interesting to dive into
